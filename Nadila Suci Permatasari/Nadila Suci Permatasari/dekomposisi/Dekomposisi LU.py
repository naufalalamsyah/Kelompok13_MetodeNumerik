...
# Mendefinisikan fungsi 'jalanLU'  
def jalanLU(A, b):
    n = len(A)  # ukuran matriks A
    L = np.zeros((n, n))  # Inisialisasi matriks L dengan 0
    for i in range(n):
    ...
    y = np.zeros((n, 1))  # untuk membuat matriks vektor y
    y[0][0] = b[0][0] / L[0][0]  # hitung elemen pertama matriks y
    ...
    x = np.zeros((n, 1))  # untuk membuat matriks vektor x
...
# Panggil fungsi 'jalanLU' dengan matriks A dan b yang dimasukkan oleh user
